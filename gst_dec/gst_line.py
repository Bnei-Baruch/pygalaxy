...
overlay_dict['5024'] = pipeline.get_by_name('overlay')
overlay_dict['5026'] = pipeline.get_by_name('overlay2')
overlay_dict['5028'] = pipeline.get_by_name('overlay3')
overlay_dict['5030'] = pipeline.get_by_name('overlay4')
global q
q = Queue()
...
while 1:
    ...
    if message!='':
        try:
            ...
            print tt_log()+' [main loop] Can not update title, broken message'
