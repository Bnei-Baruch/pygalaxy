...
udpsrc timeout=1000000000 port=8014 caps="application/x-rtp, media=video, payload=100, clock-rate=90000, encoding-name=VP8-DRAFT-IETF-01" ! 
...
decklinkvideosink device-number=0 mode=3''')

pipeline.set_state(Gst.State.PLAYING)
sleep(3)
bus = pipeline.get_bus()
overlay_dict = {'8014': pipeline.get_by_name('overlay')}
global q
q = Queue()
