...
overlay_dict = {
    '5024': pipeline.get_by_name('tittle2'),
    '5026': pipeline.get_by_name('tittle3'),
    '5028': pipeline.get_by_name('tittle1'),
    '5030': pipeline.get_by_name('tittle4')
}
